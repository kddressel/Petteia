...
namespace Assets.Petteia.Scripts.Model
{
  public static class RulesFactory
  {
    ...
    public static RulesSet MakeRulesSet(int numSpacesAllowedThisTurn) => new DiceRollNumSpacesRulesSet(MaxRoll, numSpacesAllowedThisTurn);
  }
  ...
  public class GameModelTester : MonoBehaviour
  {
    ...
    private void Awake()
    {
      ...
      gameModel = new GameModel<RulesSet>(playerDefs, 8, 8, RulesFactory.MakeRulesSet(8));
